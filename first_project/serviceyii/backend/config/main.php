    ...
    'components' => [
        ...
        'response' => [
            ...
            'on beforeSend' => function ($event) {
                ...
                $event->sender->headers->add('Access-Control-Allow-Methods', 'GET, POST, OPTIONS');
                $event->sender->headers->add('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept');
            },
        ],
        'user' => [
